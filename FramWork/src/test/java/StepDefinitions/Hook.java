    ...
    public  void initializeTest() {
        ...
        if(browserName.equalsIgnoreCase("chrome")){
            ...
            if (getOsNameFromSystem.contains("Mac")) {
                System.setProperty("webdriver.chrome.driver", "/Users/midul/IdeaProjects/BddCucumber/FramWork/src/driver/chromedriver");
            } else if (getOsNameFromSystem.contains("Windows")) {
                System.setProperty("webdriver.chrome.driver", "FramWork/src/driver/chromedriver.exe");
            }
            ...
            if (getOsNameFromSystem.contains("Windows")) {
                System.setProperty("webdriver.gecko.driver", "..FramWork/driver/geckodriver.exe");
                // driver = new FirefoxDriver(options);
            } else if (getOsNameFromSystem.contains("Mac")) {
                System.setProperty("webdriver.gecko.driver", "FramWork/driver/geckodriver");
                //  driver = new FirefoxDriver(options);
            }
